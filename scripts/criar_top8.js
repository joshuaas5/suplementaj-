...
const SUPLEMENTOS = [
  { posicao: 1, nome: 'Creatina Monohidratada', categoria: 'Performance', nota: 9.8, descricao: 'O suplemento mais estudado e comprovado cientificamente.', beneficios: ['Ganho de forca', 'Aumento muscular'], paraQuem: 'Atletas', linkArtigo: '/blog/guia-completo-creatina-2026', linkAfiliado: 'https://www.amazon.com.br/s?k=creatina&tag=105c91-20', destaque: true },
  { posicao: 2, nome: 'Vitamina D3', categoria: 'Saude', nota: 9.6, descricao: 'Essencial para imunidade e ossos.', beneficios: ['Imunidade', 'Ossos'], paraQuem: 'Todos', linkArtigo: '/blog/vitamina-d-deficiencia-brasileiros', linkAfiliado: 'https://www.amazon.com.br/s?k=vitamina+d3&tag=105c91-20', destaque: true },
  ...
  { posicao: 4, nome: 'Whey Protein', categoria: 'Performance', nota: 9.2, descricao: 'Proteina para recuperacao muscular.', beneficios: ['Musculos', 'Recuperacao'], paraQuem: 'Atletas', linkArtigo: '/blog/whey-isolado-vs-concentrado', linkAfiliado: 'https://www.amazon.com.br/s?k=whey+protein&tag=105c91-20', destaque: false },
...
function getBoxClasses(isDestaque: boolean) {
  return isDestaque 
...
function getPosClasses(pos: number) {
  return pos <= 3
...
fs.writeFileSync('app/melhores-suplementos/page.tsx', code, 'utf8');
