...
export const metadata: Metadata = {
  title: 'Top 8 Melhores Suplementos 2026: Como Escolher por Objetivo',
  description: 'Ranking dos 8 melhores suplementos de 2026 baseado em ciência e custo-benefício: creatina, vitamina D, ômega-3, whey, magnésio e mais.',
  alternates: {
...
const SUPLEMENTOS = [
  ...
  { posicao: 2, nome: 'Vitamina D3', categoria: 'Saúde', nota: 9.6, descricao: 'Essencial para imunidade.', beneficios: ['Imunidade', 'Ossos'], paraQuem: 'Todos', linkArtigo: '/blog/vitamina-d-deficiencia-brasileiros', linkAfiliado: 'https://www.amazon.com.br/s?k=vitamina+d3&tag=105c91-20', destaque: true },
  { posicao: 3, nome: 'Omega-3', categoria: 'Saúde', nota: 9.4, descricao: 'Protege coração e cérebro.', beneficios: ['Coração', 'Cérebro'], paraQuem: 'Todos', linkArtigo: '/blog/omega-3-beneficios-comprovados', linkAfiliado: 'https://www.amazon.com.br/s?k=omega+3&tag=105c91-20', destaque: false },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-block bg-yellow-400 border-4 border-black shadow-[8px_8px_0_0_#000] px-8 py-4 mb-6 -rotate-1">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-black uppercase">Top 8 Suplementos 2026</h1>
          </div>
        ...
        <div className="mt-16 bg-gradient-to-br from-cyan-400 to-blue-500 border-4 border-black shadow-[8px_8px_0_0_#000] p-8 text-center">
          ...
          <Link href="/avaliacao"><Button variant="primary" size="lg" className="text-xl">Fazer Avaliação</Button></Link>
        </div>
