...
// Atualizado em 20/05/2026 - Cobertura completa de 82 artigos
...
export const nutrienteToArtigos: Record<string, string[]> = {
  ...
  'calcio': ['vitamina-d-deficiencia-brasileiros', 'calcio-ossos-osteoporose-qual-tomar', 'vitamina-k2-d3-calcio-ossos-coracao'],
  'caseina': ['diferenca-proteinas-whey-caseina-albumina'],
  'coenzima-q10': ['coenzima-q10-coq10-energia-coracao'],
  'colageno': ['colageno-hidrolisado-funciona-pele-articulacoes', 'glucosamina-condroitina-articulacoes-artrite'],
  'creatina': ['guia-completo-creatina-2026', 'bcaa-aminoacidos-massa-muscular-funciona', 'l-carnitina-queima-gordura-performance', 'cafeina-performance-dose-pre-treino', 'whey-isolado-vs-concentrado'],
  ...
  'glucosamina': ['glucosamina-condroitina-articulacoes-artrite'],
  'iodo': ['iodo-tireoide-hipotireoidismo-dose', 'selenio-tireoide-imunidade-antioxidante'],
  'l-carnitina': ['l-carnitina-queima-gordura-performance', 'deficit-calorico-quanto-cortar', 'neat-fator-oculto-dieta', 'macros-para-definicao-muscular', 'plateau-dieta-como-sair'],
  ...
  'omega-3': ['omega-3-beneficios-comprovados', 'curcuma-curcumina-inflamacao-articulacoes', 'coenzima-q10-coq10-energia-coracao', '5-suplementos-mais-vendidos', 'suplementos-para-iniciantes'],
  ...
  'vitamina-k2': ['calcio-ossos-osteoporose-qual-tomar', 'vitamina-k2-d3-calcio-ossos-coracao'],
