...
// Atualizado em 20/05/2026 - Cobertura completa de 127 artigos
...
export const nutrienteToArtigos: Record<string, string[]> = {
  'acido-folico': ['vitamina-b12-vegetarianos-veganos', 'acido-folico-b9-gestantes-gravidez', 'vitamina-b12-baixa-sintomas'],
  'albumina': ['albumina-ou-whey-qual-melhor', 'diferenca-proteinas-whey-caseina-albumina'],
  ...
  'calcio': ['vitamina-d-deficiencia-brasileiros', 'calcio-ossos-osteoporose-qual-tomar', 'vitamina-k2-d3-calcio-ossos-coracao', 'vitamina-d3-k2-juntas-beneficios', 'vitamina-d-baixa-sintomas'],
  ...
  'ferro': ['vitamina-b12-vegetarianos-veganos', 'ferro-anemia-deficiencia-tratamento', 'spirulina-superalimento-proteina-vegana', 'acido-folico-b9-gestantes-gravidez', 'vitamina-b12-baixa-sintomas'],
  ...
  'omega-3': ['omega-3-beneficios-comprovados', 'curcuma-curcumina-inflamacao-articulacoes', 'coenzima-q10-coq10-energia-coracao', 'suplementos-para-emagrecer-funcionam', 'gordura-na-dieta-quanto-consumir'],
  'probioticos': ['probioticos-intestino-flora-intestinal'],
  'proteina': ['guia-completo-creatina-2026', 'bcaa-aminoacidos-massa-muscular-funciona', 'creatina-guia-completo-ganho-muscular', 'creatina-e-whey-juntos', 'creatina-para-vegetarianos'],
  ...
  'vitamina-b12': ['vitamina-b12-vegetarianos-veganos', 'ferro-anemia-deficiencia-tratamento', 'spirulina-superalimento-proteina-vegana', 'acido-folico-b9-gestantes-gravidez', 'creatina-para-vegetarianos'],
  ...
  'vitamina-e': ['omega-3-beneficios-comprovados', 'selenio-tireoide-imunidade-antioxidante', 'vitamina-e-antioxidante-pele-fertilidade', 'gordura-na-dieta-quanto-consumir'],
